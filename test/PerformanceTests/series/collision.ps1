...
if ($RunEP1)
{
	./series/runsingle -Tag azst-12    -HubName A11 -Plan EP1 -NumNodes 1 -WaitForDeploy 120 -Orchestration CollisionSearch/divide-and-conquer -Data 100 -ResultsFile $ResultsFile -ThroughputUnits 1
 	./series/runsingle -Tag neth       -HubName L11 -Plan EP1 -NumNodes 1 -WaitForDeploy 50 -Orchestration CollisionSearch/divide-and-conquer -Data 100 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L12 -Plan EP1 -NumNodes 4 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 200 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L13 -Plan EP1 -NumNodes 8 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 300 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L14 -Plan EP1 -NumNodes 12 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 400 -ResultsFile $ResultsFile -ThroughputUnits $tu -DeleteAfterTests $true
...
if ($RunEP2)
{
 	./series/runsingle -Tag azst-12    -HubName A21 -Plan EP2 -NumNodes 1 -WaitForDeploy 120 -Orchestration CollisionSearch/divide-and-conquer -Data 200 -ResultsFile $ResultsFile -ThroughputUnits 1
  	./series/runsingle -Tag neth       -HubName L21 -Plan EP2 -NumNodes 1 -WaitForDeploy 50 -Orchestration CollisionSearch/divide-and-conquer -Data 200 -ResultsFile $ResultsFile -ThroughputUnits $tu
 	...
 	./series/runsingle -Tag neth       -HubName L22 -Plan EP2 -NumNodes 4 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 300 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L23 -Plan EP2 -NumNodes 8 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 400 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L24 -Plan EP2 -NumNodes 12 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 500 -ResultsFile $ResultsFile -ThroughputUnits $tu -DeleteAfterTests $true
...
if ($RunEP3)
{
	./series/runsingle -Tag azst-12    -HubName A31 -Plan EP3 -NumNodes 1 -WaitForDeploy 120 -Orchestration CollisionSearch/divide-and-conquer -Data 300 -ResultsFile $ResultsFile -ThroughputUnits 1
 	./series/runsingle -Tag neth       -HubName L31 -Plan EP3 -NumNodes 1 -WaitForDeploy 50 -Orchestration CollisionSearch/divide-and-conquer -Data 300 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L32 -Plan EP3 -NumNodes 4 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 600 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L33 -Plan EP3 -NumNodes 8 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 1000 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L34 -Plan EP3 -NumNodes 12 -WaitForDeploy 80 -Orchestration CollisionSearch/divide-and-conquer -Data 1000 -ResultsFile $ResultsFile -ThroughputUnits $tu -DeleteAfterTests $true
