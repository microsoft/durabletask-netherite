...
if ($RunEP1)
{
	./series/runsingle -Tag azst-12    -HubName A11 -Plan EP1 -NumNodes 1 -WaitForDeploy 15 -Orchestration "WordCount?shape=5x20" -Data 5 -ResultsFile $ResultsFile -ThroughputUnits 1
 	./series/runsingle -Tag neth -HubName L11 -Plan EP1 -NumNodes 1 -WaitForDeploy 50 -Orchestration "WordCount?shape=10x30" -Data 10 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth -HubName L12 -Plan EP1 -NumNodes 4 -WaitForDeploy 80 -Orchestration "WordCount?shape=10x30" -Data 10 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth -HubName L13 -Plan EP1 -NumNodes 8 -WaitForDeploy 80 -Orchestration "WordCount?shape=10x30" -Data 10 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth -HubName L14 -Plan EP1 -NumNodes 12 -WaitForDeploy 80 -Orchestration "WordCount?shape=15x40" -Data 15 -ResultsFile $ResultsFile -ThroughputUnits $tu -DeleteAfterTests $true
...
if ($RunEP2)
{
	./series/runsingle -Tag azst-12    -HubName A21 -Plan EP2 -NumNodes 1 -WaitForDeploy 15 -Orchestration "WordCount?shape=10x30" -Data 10 -ResultsFile $ResultsFile -ThroughputUnits 1
 	./series/runsingle -Tag neth       -HubName L21 -Plan EP2 -NumNodes 1 -WaitForDeploy 50 -Orchestration "WordCount?shape=10x30" -Data 10 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L22 -Plan EP2 -NumNodes 4 -WaitForDeploy 80 -Orchestration "WordCount?shape=15x40" -Data 15 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L23 -Plan EP2 -NumNodes 8 -WaitForDeploy 80 -Orchestration "WordCount?shape=15x40" -Data 15 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L24 -Plan EP2 -NumNodes 12 -WaitForDeploy 80 -Orchestration "WordCount?shape=15x40" -Data 15 -ResultsFile $ResultsFile -ThroughputUnits $tu -DeleteAfterTests $true
...
if ($RunEP3)
{
	./series/runsingle -Tag azst-12    -HubName A31 -Plan EP3 -NumNodes 1 -WaitForDeploy 15 -Orchestration "WordCount?shape=10x30" -Data 10 -ResultsFile $ResultsFile -ThroughputUnits 1
 	./series/runsingle -Tag neth       -HubName L31 -Plan EP3 -NumNodes 1 -WaitForDeploy 50 -Orchestration "WordCount?shape=15x40" -Data 15 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L32 -Plan EP3 -NumNodes 4 -WaitForDeploy 80 -Orchestration "WordCount?shape=20x50" -Data 20 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L33 -Plan EP3 -NumNodes 8 -WaitForDeploy 80 -Orchestration "WordCount?shape=20x50" -Data 20 -ResultsFile $ResultsFile -ThroughputUnits $tu
	...
	./series/runsingle -Tag neth       -HubName L34 -Plan EP3 -NumNodes 12 -WaitForDeploy 80 -Orchestration "WordCount?shape=20x50" -Data 20 -ResultsFile $ResultsFile -ThroughputUnits $tu -DeleteAfterTests $true
