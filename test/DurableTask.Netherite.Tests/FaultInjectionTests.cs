...
namespace DurableTask.Netherite.Tests
{
    ...
    public class FaultInjectionTests : IDisposable
    {
        ...
        public async Task InjectStartup()
        {
            ...
            {
                fixture = await SingleHostFixture.StartNew(this.settings, true, null, TimeSpan.FromMinutes(2), (msg) => this.outputHelper.WriteLine(msg));
        ...
        {
            using (var fixture = await SingleHostFixture.StartNew(this.settings, true, null, TimeSpan.FromMinutes(1), (msg) => this.outputHelper?.WriteLine(msg)))
            {
