...
namespace DurableTask.Netherite
{
        ...
        IDisposable
    {
        ...
        public bool TryGetScalingMonitor(out ScalingMonitor monitor)
        {
            ...
            {
                monitor = new ScalingMonitor(this.Settings.ResolvedStorageConnectionString, this.Settings.ResolvedTransportConnectionString, this.Settings.LoadInformationAzureTableName, this.Settings.HubName);
                return true;
            }
            else
            {
